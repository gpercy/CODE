...
! testing this module with an output file
  open(IIN,file='OUTPUT_FILES/fault_xyz.dat',status='replace',action='write')
   write(IIN,*) size(fault_nodes_coord,2)
   write(IIN,*) fault_nodes_coord(1,:),fault_nodes_coord(2,:),fault_nodes_coord(3,:)
  close(IIN) 

!  3. allocate arrays and set to zero
  allocate(DataT0%d1(NTOUT,DataT0%npoin))
  allocate(DataT0%v1(NTOUT,DataT0%npoin))
  allocate(DataT0%t1(NTOUT,DataT0%npoin))
  allocate(DataT0%d2(NTOUT,DataT0%npoin))
  allocate(DataT0%v2(NTOUT,DataT0%npoin))
  allocate(DataT0%t2(NTOUT,DataT0%npoin))
  allocate(DataT0%t3(NTOUT,DataT0%npoin))
